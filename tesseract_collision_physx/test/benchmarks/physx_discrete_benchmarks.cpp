...
{
  TesseractPhysxDesc physx_description;
  physx_description.worker_threads = 1;
  physx_description.enable_gpu = false;
  // These values are not tuned in any way.
  physx_description.cuda_dynamics_config.constraintBufferCapacity = (0 * 128 * 128);
  physx_description.cuda_dynamics_config.contactBufferCapacity = (24 * 128 * 128);
  physx_description.cuda_dynamics_config.tempBufferCapacity = (16 * 128 * 128);
  physx_description.cuda_dynamics_config.contactStreamSize = (16 * 128 * 128);
  physx_description.cuda_dynamics_config.patchStreamSize = (5 * 128 * 128);
  physx_description.cuda_dynamics_config.forceStreamCapacity = (64 * 128 * 128);
  physx_description.cuda_dynamics_config.heapCapacity = (64 * 128 * 128);
  physx_description.cuda_dynamics_config.foundLostPairsCapacity = (128 * 128);

  const tesseract_collision::PhysxDiscreteManager::ConstPtr checker =
      std::make_shared<tesseract_collision::PhysxDiscreteManager>(physx_description);
