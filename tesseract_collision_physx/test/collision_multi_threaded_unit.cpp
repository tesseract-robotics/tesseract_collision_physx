...
TEST(TesseractCollisionMultiThreadedUnit, PhysxDiscreteCollisionMultiThreadedConvexHullUnit)  // NOLINT
{
  PhysxDiscreteManager checker;
  test_suite::runTest(checker, true);
}

TEST(TesseractCollisionMultiThreadedUnit, PhysxDiscreteCollisionMultiThreadedUnit)  // NOLINT
{
  PhysxDiscreteManager checker;
